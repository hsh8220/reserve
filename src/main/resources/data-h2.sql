...
insert into member (name, pw, role, user_id, congregation_id, gender) values ('admin', '000000', 'ADMIN', 'admin', 1, '남자');
insert into member (name, pw, role, user_id, congregation_id, gender) values ('한상호', '000000', 'ADMIN', '한상호', 1, '남자');
